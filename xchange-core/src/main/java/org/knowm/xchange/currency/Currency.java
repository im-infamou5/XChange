...
public class Currency implements Comparable<Currency>, Serializable {
  ...
  public static final Currency SAND = createCurrency("SAND", "The Sandbox", null);
  public static final Currency DOT = createCurrency("DOT", "Polkadot", null);
  public static final Currency WNXM = createCurrency("WNXM", "Wrapped NXM", null);
  public static final Currency TRB = createCurrency("TRB", "Tellor", null);
  public static final Currency BZRX = createCurrency("BZRX", "bZx Protocol", null);
  public static final Currency SUSHI = createCurrency("SUSHI ", "SushiSwap", null);
  public static final Currency YFII = createCurrency("YFII", "DFI.Money", null);
  public static final Currency EGLD = createCurrency("EGLD", "Elrond", null);
  public static final Currency DIA = createCurrency("DIA", "DIA", null);
  public static final Currency RUNE = createCurrency("RUNE", "THORChain", null);
  public static final Currency FIO = createCurrency("FIO", "FIO Protocol", null);
  public static final Currency UMA = createCurrency("UMA", "UMA", null);
  public static final Currency BEL = createCurrency("BEL", "Bella Protocol", null);
  public static final Currency WING = createCurrency("WING", "Wing", null);
  public static final Currency UNI = createCurrency("UNI", "Uniswap", null);
  public static final Currency NBS = createCurrency("NBS", "New Bitshares", null);
  public static final Currency OXT = createCurrency("OXT", "Orchid", null);
  public static final Currency SUN = createCurrency("SUN", "SUN", null);
  public static final Currency AVAX = createCurrency("AVAX", "Avalanche", null);
  public static final Currency HNT = createCurrency("HNT", "Helium", null);
  public static final Currency FLM = createCurrency("FLM", "Flamingo", null);
  public static final Currency ORN = createCurrency("ORN", "Orion Protocol", null);
  public static final Currency XVS = createCurrency("XVS", "Venus", null);
  public static final Currency YFI = createCurrency("YFI", "yearn.finance", null);
  public static final Currency BAL = createCurrency("BAL", "Balancer", null);
  public static final Currency BLZ = createCurrency("BLZ", "Bluezelle", null);
  public static final Currency AAVE = createCurrency("AAVE", "Aave", null);
  public static final Currency NEAR = createCurrency("NEAR", "Near Protocol", null);
  public static final Currency FIL = createCurrency("FIL", "Filecoin", null);
  public static final Currency INJ = createCurrency("INJ", "Injective Protocol", null);
  public static final Currency AUDIO = createCurrency("AUDIO", "Audius", null);
  public static final Currency CTK = createCurrency("CTK", "CertiK", null);
  public static final Currency AKRO = createCurrency("AKRO", "Akropolis", null);
  public static final Currency AXS = createCurrency("AXS", "Axie Infinity", null);
  public static final Currency HARD = createCurrency("HARD", "HARD Protocol", null);
  public static final Currency DNT = createCurrency("DNT", "district0x", null);
  public static final Currency STRAX = createCurrency("STRAX ", "Stratis", null);
  public static final Currency UNFI = createCurrency("UNFI", "Uniswap Finance", null);
  public static final Currency ROSE = createCurrency("ROSE", "Oasis Network", null);
  public static final Currency SKL = createCurrency("SKL", "SKALE Network", null);
  public static final Currency GRT = createCurrency("GRT", "The Graph", null);
  public static final Currency REEF = createCurrency("REEF", "Reef", null);
  public static final Currency CELO = createCurrency("CELO", "Celo", null);
  public static final Currency ONG = createCurrency("ONG", "Ontology Gas", null);
  public static final Currency MITH = createCurrency("MITH", "Mithril", null);
  public static final Currency ARPA = createCurrency("ARPA", "ARPA Chain", null);
  public static final Currency CVC = createCurrency("CVC", "Civic", null);
  public static final Currency COCOS = createCurrency("COCOS ", "Cocos-BCX", null);
  public static final Currency GTO = createCurrency("GTO", "Gifto", null);
  public static final Currency DUSK = createCurrency("DUSK", "Dusk Network", null);
  public static final Currency COS = createCurrency("COS", "Contentos", null);
  public static final Currency DENT = createCurrency("DENT", "Dent", null);
  public static final Currency MFT = createCurrency("MFT", "Mainframe", null);
  public static final Currency KEY = createCurrency("KEY", "Selfkey", null);
  public static final Currency DOCK = createCurrency("DOCK", "Dock", null);
  public static final Currency NKN = createCurrency("NKN", "NKN", null);
  public static final Currency TROY = createCurrency("TROY", "TROY", null);
  public static final Currency VITE = createCurrency("VITE", "VITE", null);
  public static final Currency DREP = createCurrency("DREP", "DREP", null);
  public static final Currency TCT = createCurrency("TCT", "TokenClub", null);
  public static final Currency LTO = createCurrency("LTO", "LTO Network", null);
  public static final Currency MBL = createCurrency("MBL", "MovieBloc", null);
  public static final Currency STPT = createCurrency("STPT", "Standard Tokenization Protocol", null);
  public static final Currency CTSI = createCurrency("CTSI", "Cartesi", null);
